...
`229b1eb`. Our current side is panel 0.22.1 at
[`6d6eea6`](https://github.com/xtimmy86x/MyHOME/tree/6d6eea6138773120ff7b92b40901ec49d1d90a6d);
`e7b4d32` is the preceding temporary-inventory implementation;
...
| --- | --- | --- |
| Our `feat/myhome-sidepanel`, panel 0.22.1 | [`6d6eea6`](https://github.com/xtimmy86x/MyHOME/tree/6d6eea6138773120ff7b92b40901ec49d1d90a6d) | [Implemented API](panel-websocket-api.md), `panel.py`, `cover_profiles.py`, `cover_profile_provenance.py`, `cover_profile_export.py`, `cover_calibration.py`, `cover_calibration_automatic.py`, `cover_calibration_batch.py`, `hardware_inspection.py`, `frontend/panel/` |
